...
if (do_authentication):
    login=opener.open("https://rda.ucar.edu/cgi-bin/login","email=diego.aliaga@helsinki.fi&password="+sys.argv[1]+"&action=login")
    #
...
listoffiles=["2017/cdas1.20171231.sfluxgrbf.tar","2017/cdas1.20171231.splgrbf.tar","2018/cdas1.20180101.sfluxgrbf.tar","2018/cdas1.20180101.splgrbf.tar","2018/cdas1.20180102.sfluxgrbf.tar","2018/cdas1.20180102.splgrbf.tar","2018/cdas1.20180103.sfluxgrbf.tar"]
